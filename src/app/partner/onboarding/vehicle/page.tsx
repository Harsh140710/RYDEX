...
const VEHICLE = [
  ...
  { id: "auto", label: "Auto", icon: Car, desc: "3 weehler ride" },
  { id: "car", label: "Car", icon: Car, desc: "4 weehler ride" },
...
function page() {
  ...
  const handleVehicle = async () => {
    ...
    try {
      ...
      setError(error?.response?.data?.message ?? "Semething went wrong.");
      setLoading(false);
    }
  };
