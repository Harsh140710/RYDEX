...
function Navbar() {
  ...
  return (
    <>
                      ...
                      >
                        ...
                        <div className="p-5">
                          ...
                          {userData.role !== "partner" && (
                            <div
                              className="w-full flex items-center gap-3 py-3 hover:bg-gray-100 rounded-xl font-semibold cursor-pointer"
                              onClick={() =>
                          ...
                          {/* Log Out Button */}
                          <button
                            className="w-full flex items-center gap-3 py-2 hover:bg-red-100/100 hover:text-red-500 hover:border hover:border-red-500 rounded-xl mt-2 cursor-pointer font-semibold"
      ...
      {/* This MENU is for only mobile view */}
      <AnimatePresence>
        {menuOpen && (
          <>
            {/* Dark background */}
      ...
      {/* This PROFILE is for only mobile view */}
      <AnimatePresence>
